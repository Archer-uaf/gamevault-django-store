...
class Command(BaseCommand):
    ...
    # Steam UA price snapshot collected on 2026-07-09; not live-synced.
    GAMES: tuple[dict[str, Any], ...] = (
        ...
        },
        {
            ...
            "discount_percent": 50,
            "is_featured": False,
            "cover_url": steam_header(3240220),
        },
        {
            "name": "Elden Ring",
            "slug": "elden-ring",
        ...
        },
        {
            ...
            "description": text(
                "Глобальна strategy про Другу світову війну, дипломатію,",
                "виробництво та великі кампанії, де рішення змінюють карту світу.",
            ),
            "description_en": text(
                "A grand strategy game about World War II, diplomacy, production,",
                "and large campaigns where decisions reshape the world map.",
            ),
            "price": Decimal("1349.00"),
            "category_slug": "strategy",
            "platform": Product.Platform.PC,
            ...
            "release_date": date(2016, 6, 6),
            "stock": 28,
            "discount_percent": 80,
            "is_featured": False,
            "cover_url": steam_header(394360),
        },
        {
            "name": "No Man's Sky",
            "slug": "no-mans-sky",
